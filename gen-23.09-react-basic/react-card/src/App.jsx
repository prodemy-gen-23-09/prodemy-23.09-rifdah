...
function App() {
  ...
  return (
    <div className="grid grid-cols-3 gap-40 mt-40 mr-4 ml-80 min-h-screen absolute top-1 left-1 -translate-x-1 -translate-y-1 font-Jost">
    {products.map((product, id) => (
      /* Mengirimkan data melalui props ke ChildComponent */
      <ProductCard
        key={product.id}
        img={product.img}
        title={product.title}
