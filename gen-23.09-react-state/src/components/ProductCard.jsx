...
const ProductCard = () => {
  ...
  // // Function to set preview product and update main image
  // function setPreviewProduct(
  //   productId,
  //   productName,
  //   productPrice,
  //   productImage
  // ) {
  //   const previewProductUrl =
  //     "previewproduct.html?id=" +
  //     productId +
  //     "&name=" +
  ...
  //   window.location.href = previewProductUrl;
  // }
