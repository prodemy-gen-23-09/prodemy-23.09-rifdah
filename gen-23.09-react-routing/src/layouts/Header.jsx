...
const Header = () => {
  ...
  return (
    ...
    // <div className="fixed top-0 right-0 w-full h-28 py-2 shadow-sm bg-white ">
    //   <div className="container flex max-w-[1640px] mx-auto -mt-8 items-center justify-between p-4">
