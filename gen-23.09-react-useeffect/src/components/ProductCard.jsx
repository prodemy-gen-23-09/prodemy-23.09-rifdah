...
const ProductCard = (props) => {
  useEffect(() => {
    ...
    if (props.sortDate === "newest") {
      sortedProducts.sort(
        (a, b) => new Date(b.releaseDate) - new Date(a.releaseDate)
      );
    } else if (props.sortDate === "oldest") {
      sortedProducts.sort(
        (a, b) => new Date(a.releaseDate) - new Date(b.releaseDate)
      );
    }

    if (props.sortPrice === "highest") {
      sortedProducts.sort((a, b) => b.price - a.price);
    } else if (props.sortPrice === "lowest") {
      sortedProducts.sort((a, b) => a.price - b.price);
    }

    props.setProducts(sortedProducts);
  }, [props.sortDate, props.products, props.sortPrice, props.setProducts]);
